...
LIBS = `pkg-config --libs wayland-client libzstd` -lm
...
OBJS = src/main.o src/capture.o src/kitty.o src/base64.o src/diff.o src/compress.o src/scale.o $(PROTO_SRC:.c=.o)
TARGET = kgp-test-bin
